...
#Staff.create(user_data.merge first_name: 'John', email: 'kim_john3@bah.com', role: :admin)
Staff.create(user_data.merge first_name: 'Ruben', email: 'montenegro_ruben@bah.com', role: :admin)
